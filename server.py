...
### STEP 2: keywords 확인
- STEP 1 완료 후에만 진행
- context.keywords가 있으면: response: "현재 키워드: {keywords}. 이대로 사용할까요? 아니면 시즌·상황에 맞게 변경하시겠어요?"
- context.keywords가 없으면: 장르와 시즌에 맞는 한국어 키워드 10개 이상 제안
- ★ 키워드는 반드시 한국어 단어/문구로만 작성 (예: "개막", "올스타", "우승", "황금연휴")
